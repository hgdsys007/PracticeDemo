...
import com.lzz.studydemo.ui.activity.Pull2finishActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.pull2finish).setOnClickListener(this);
	...
	private void setupUltraViewPager() {
		...
		//设置indicator样式
		ultraViewPager.getIndicator().setOrientation(UltraViewPager.Orientation.HORIZONTAL).setFocusColor(Color.GREEN)
				.setNormalColor(Color.WHITE).setRadius((int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5,
	...
	private void pull2finish() {
		Pull2finishActivity.startActivity(this);
	}
